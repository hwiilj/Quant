# origin : https://youtu.be/eQeu8v_-Y98
# CAGR : 17.2%, 16.1%
import requests
...
if data[0][4] <0 or data[1][4]<0 or data[2][4]<0 or data[3][4]<0:
    print("Go defence 1st among (SHY IEF LQD)")
else:
    print("Go attack 1st among (SPY VEA VWO AGG)")
